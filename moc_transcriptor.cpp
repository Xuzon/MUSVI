...
QT_MOC_LITERAL(1, 13, 10), // "launchBeep"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 15), // "StopCalibration"
QT_MOC_LITERAL(4, 41, 6), // "record"
QT_MOC_LITERAL(5, 48, 9) // "comboList"

    },
    "Transcriptor\0launchBeep\0\0StopCalibration\0"
    "record\0comboList"
};
...
void Transcriptor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->launchBeep(); break;
        case 1: _t->StopCalibration(); break;
        case 2: _t->record(); break;
        case 3: { QStringList _r = _t->comboList();
        ...
        {
            typedef void (Transcriptor::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Transcriptor::launchBeep)) {
                *result = 0;
                return;
            }
        }
