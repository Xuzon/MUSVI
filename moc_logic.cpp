...
QT_MOC_LITERAL(6, 58, 17), // "ChangeTempoCompas"
QT_MOC_LITERAL(7, 76, 3), // "bpm"
QT_MOC_LITERAL(8, 80, 12), // "subdivisions"
QT_MOC_LITERAL(9, 93, 11) // "detectPulse"

    },
    "Musvi_Logic\0sendPulse\0\0pulse\0"
    "startRecording\0stopRecording\0"
    "ChangeTempoCompas\0bpm\0subdivisions\0"
    "detectPulse"
};
...
void Musvi_Logic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->ChangeTempoCompas((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->detectPulse((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Musvi_Logic::sendPulse)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Musvi_Logic::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Musvi_Logic.data,
      qt_meta_data_Musvi_Logic,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Musvi_Logic::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Musvi_Logic.stringdata0))
        return static_cast<void*>(const_cast< Musvi_Logic*>(this));
